...
for /f "usebackq tokens=2 delims=\" %%a n (`reg query "HKEY_USERS" ^| findstr /r /x /c:"HKEY_USERS\\S-.*"`) do (
	...
	reg query "HKU\%%a" | findstr /c:"Volatile Environment"
	if not !errorlevel! == 1 (
		call :SETPFP "%%a"
	)
)
...
reg add "!usrPfpRegKey!" /f
reg add "!usrPfpRegKey!" /v "Image32" /t REG_SZ /d "!usrPfpDir!\32x32.png" /f
reg add "!usrPfpRegKey!" /v "Image40" /t REG_SZ /d "!usrPfpDir!\40x40.png" /f
reg add "!usrPfpRegKey!" /v "Image48"/t REG_SZ /d "!usrPfpDir!\48x48.png" /f
reg add "!usrPfpRegKey!" /v "Image64" /t REG_SZ /d "!usrPfpDir!\64x64.png" /f
reg add "!usrPfpRegKey!" /v "Image96"/t REG_SZ /d "!usrPfpDir!\96x96.png" /f
reg add "!usrPfpRegKey!" /v "Image192" /t REG_SZ /d "!usrPfpDir!\192x192.png" /f
reg add "!usrPfpRegKey!" /v "Image208" /t REG_SZ /d "!usrPfpDir!\208x208.png" /f
reg add "!usrPfpRegKey!" /v "Image240" /t REG_SZ /d "!usrPfpDir!\240x240.png" /f
reg add "!usrPfpRegKey!" /v "Image424" /t REG_SZ /d "!usrPfpDir!\424x424.png" /f
reg add "!usrPfpRegKey!" /v "Image448" /t REG_SZ /d "!usrPfpDir!\448x448.png" /f
reg add "!usrPfpRegKey!" /v "Image1080" /t REG_SZ /d "!usrPfpDir!\1080x1080.png" /f
